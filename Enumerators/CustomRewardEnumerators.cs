...
public static class CustomRewardEnumerators
{
    /// <summary>Enumerates Custom Reward Redemption for a Custom Reward on a channel that was created by the same client_id.
