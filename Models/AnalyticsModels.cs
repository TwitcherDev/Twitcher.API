...
public record ExtensionAnalyticsResponseBody(string ExtensionId, DateTime EndedAt, DateTime StartedAt, string Type, [property: JsonProperty("URL")] string URL);
...
/// <param name="Type">Type of report</param>
/// <param name="URL">URL to the downloadable CSV file containing analytics data. Valid for 5 minutes</param>
public record GameAnalyticsResponseBody(string GameId, DateTime EndedAt, DateTime StartedAt, string Type, [property: JsonProperty("URL")] string URL);
