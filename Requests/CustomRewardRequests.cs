...
public static class CustomRewardRequests
{
    ...
    /// <exception cref="NotAvailableException"></exception>
    /// <exception cref="NotFoundException"></exception>
    public static async Task<CustomRewardResponse[]?> GetCustomRewards(this TwitcherAPI api, string broadcasterId, Guid id = default)
    {
    ...
    /// <exception cref="NotAvailableException"></exception>
    /// <exception cref="NotFoundException"></exception>
    public static async Task<DataPaginationResponse<RedemptionResponse[]>?> GetRedemptionStatus(this TwitcherAPI api, string broadcasterId, Guid rewardId, int first = 20, string? after = null, RedemptionStatus? status = null)
    {
    ...
    /// <exception cref="NotAvailableException"></exception>
    /// <exception cref="NotFoundException"></exception>
    public static async Task<RedemptionResponse[]?> UpdateRedemptionStatus(this TwitcherAPI api, string broadcasterId, Guid rewardId, IEnumerable<Guid> ids, RedemptionStatus status)
    {
